...
import de.audi.tghu.development.model.ButtonModel;
...
implements ElementParserIFC {
    public ScreenElementModel parseElement(String[] stringArray, TokenReaderIFC tokenReaderIFC) throws ParseException {
        ...
        if (stringArray[0].toLowerCase().equals("button")) {
            ...
            try {
                while (tokenReaderIFC.ready()) {
                    ...
                    if (stringArray2[0].toLowerCase().equals("value")) {
                        ...
                        try {
                            buttonModel.setKeyValue(this.getDataSource(stringArray2[1]), Integer.decode(stringArray2[2]), Long.decode(stringArray2[3]), stringArray2[4]);
                            continue;
                        }
                    ...
                    if (stringArray2[0].equals("label")) {
                        ...
                        buttonModel.setLabel(stringArray2[1]);
                        continue;
                    }
                    if (stringArray2[0].equals("poll")) {
                        ...
                        try {
                            buttonModel.setRefreshInterval(Integer.decode(stringArray2[1]));
                            continue;
                        }
                        catch (NumberFormatException numberFormatException) {
            ...
            if (!buttonModel.areRequiredFieldsSet()) {

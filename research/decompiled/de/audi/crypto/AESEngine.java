...
implements BlockCipher {
    ...
    private final void encryptBlock(int[][] nArray) {
        ...
        while (n5 < this.ROUNDS - 1) {
            n4 = T0[this.C0 & 0xFF] ^ this.shift(T0[this.C1 >> 8 & 0xFF], 24) ^ this.shift(T0[this.C2 >> 16 & 0xFF], 16) ^ this.shift(T0[this.C3 >> 24 & 0xFF], 8) ^ nArray[n5][0];
            n3 = T0[this.C1 & 0xFF] ^ this.shift(T0[this.C2 >> 8 & 0xFF], 24) ^ this.shift(T0[this.C3 >> 16 & 0xFF], 16) ^ this.shift(T0[this.C0 >> 24 & 0xFF], 8) ^ nArray[n5][1];
            n2 = T0[this.C2 & 0xFF] ^ this.shift(T0[this.C3 >> 8 & 0xFF], 24) ^ this.shift(T0[this.C0 >> 16 & 0xFF], 16) ^ this.shift(T0[this.C1 >> 24 & 0xFF], 8) ^ nArray[n5][2];
            n = T0[this.C3 & 0xFF] ^ this.shift(T0[this.C0 >> 8 & 0xFF], 24) ^ this.shift(T0[this.C1 >> 16 & 0xFF], 16) ^ this.shift(T0[this.C2 >> 24 & 0xFF], 8) ^ nArray[n5++][3];
            this.C0 = T0[n4 & 0xFF] ^ this.shift(T0[n3 >> 8 & 0xFF], 24) ^ this.shift(T0[n2 >> 16 & 0xFF], 16) ^ this.shift(T0[n >> 24 & 0xFF], 8) ^ nArray[n5][0];
            this.C1 = T0[n3 & 0xFF] ^ this.shift(T0[n2 >> 8 & 0xFF], 24) ^ this.shift(T0[n >> 16 & 0xFF], 16) ^ this.shift(T0[n4 >> 24 & 0xFF], 8) ^ nArray[n5][1];
            this.C2 = T0[n2 & 0xFF] ^ this.shift(T0[n >> 8 & 0xFF], 24) ^ this.shift(T0[n4 >> 16 & 0xFF], 16) ^ this.shift(T0[n3 >> 24 & 0xFF], 8) ^ nArray[n5][2];
            this.C3 = T0[n & 0xFF] ^ this.shift(T0[n4 >> 8 & 0xFF], 24) ^ this.shift(T0[n3 >> 16 & 0xFF], 16) ^ this.shift(T0[n2 >> 24 & 0xFF], 8) ^ nArray[n5++][3];
        }
        n4 = T0[this.C0 & 0xFF] ^ this.shift(T0[this.C1 >> 8 & 0xFF], 24) ^ this.shift(T0[this.C2 >> 16 & 0xFF], 16) ^ this.shift(T0[this.C3 >> 24 & 0xFF], 8) ^ nArray[n5][0];
        n3 = T0[this.C1 & 0xFF] ^ this.shift(T0[this.C2 >> 8 & 0xFF], 24) ^ this.shift(T0[this.C3 >> 16 & 0xFF], 16) ^ this.shift(T0[this.C0 >> 24 & 0xFF], 8) ^ nArray[n5][1];
        n2 = T0[this.C2 & 0xFF] ^ this.shift(T0[this.C3 >> 8 & 0xFF], 24) ^ this.shift(T0[this.C0 >> 16 & 0xFF], 16) ^ this.shift(T0[this.C1 >> 24 & 0xFF], 8) ^ nArray[n5][2];
    ...
    private final void decryptBlock(int[][] nArray) {
        ...
        while (n5 > 1) {
            n4 = Tinv0[this.C0 & 0xFF] ^ this.shift(Tinv0[this.C3 >> 8 & 0xFF], 24) ^ this.shift(Tinv0[this.C2 >> 16 & 0xFF], 16) ^ this.shift(Tinv0[this.C1 >> 24 & 0xFF], 8) ^ nArray[n5][0];
            n3 = Tinv0[this.C1 & 0xFF] ^ this.shift(Tinv0[this.C0 >> 8 & 0xFF], 24) ^ this.shift(Tinv0[this.C3 >> 16 & 0xFF], 16) ^ this.shift(Tinv0[this.C2 >> 24 & 0xFF], 8) ^ nArray[n5][1];
            n2 = Tinv0[this.C2 & 0xFF] ^ this.shift(Tinv0[this.C1 >> 8 & 0xFF], 24) ^ this.shift(Tinv0[this.C0 >> 16 & 0xFF], 16) ^ this.shift(Tinv0[this.C3 >> 24 & 0xFF], 8) ^ nArray[n5][2];
            n = Tinv0[this.C3 & 0xFF] ^ this.shift(Tinv0[this.C2 >> 8 & 0xFF], 24) ^ this.shift(Tinv0[this.C1 >> 16 & 0xFF], 16) ^ this.shift(Tinv0[this.C0 >> 24 & 0xFF], 8) ^ nArray[n5--][3];
            this.C0 = Tinv0[n4 & 0xFF] ^ this.shift(Tinv0[n >> 8 & 0xFF], 24) ^ this.shift(Tinv0[n2 >> 16 & 0xFF], 16) ^ this.shift(Tinv0[n3 >> 24 & 0xFF], 8) ^ nArray[n5][0];
            this.C1 = Tinv0[n3 & 0xFF] ^ this.shift(Tinv0[n4 >> 8 & 0xFF], 24) ^ this.shift(Tinv0[n >> 16 & 0xFF], 16) ^ this.shift(Tinv0[n2 >> 24 & 0xFF], 8) ^ nArray[n5][1];
            this.C2 = Tinv0[n2 & 0xFF] ^ this.shift(Tinv0[n3 >> 8 & 0xFF], 24) ^ this.shift(Tinv0[n4 >> 16 & 0xFF], 16) ^ this.shift(Tinv0[n >> 24 & 0xFF], 8) ^ nArray[n5][2];
            this.C3 = Tinv0[n & 0xFF] ^ this.shift(Tinv0[n2 >> 8 & 0xFF], 24) ^ this.shift(Tinv0[n3 >> 16 & 0xFF], 16) ^ this.shift(Tinv0[n4 >> 24 & 0xFF], 8) ^ nArray[n5--][3];
        }
        n4 = Tinv0[this.C0 & 0xFF] ^ this.shift(Tinv0[this.C3 >> 8 & 0xFF], 24) ^ this.shift(Tinv0[this.C2 >> 16 & 0xFF], 16) ^ this.shift(Tinv0[this.C1 >> 24 & 0xFF], 8) ^ nArray[n5][0];
        n3 = Tinv0[this.C1 & 0xFF] ^ this.shift(Tinv0[this.C0 >> 8 & 0xFF], 24) ^ this.shift(Tinv0[this.C3 >> 16 & 0xFF], 16) ^ this.shift(Tinv0[this.C2 >> 24 & 0xFF], 8) ^ nArray[n5][1];
        n2 = Tinv0[this.C2 & 0xFF] ^ this.shift(Tinv0[this.C1 >> 8 & 0xFF], 24) ^ this.shift(Tinv0[this.C0 >> 16 & 0xFF], 16) ^ this.shift(Tinv0[this.C3 >> 24 & 0xFF], 8) ^ nArray[n5][2];

...
extends Widget {
    ...
    public ButtonWidget(ScreenElementModel screenElementModel, ScreenRenderer screenRenderer) {
    ...
    public void render(Graphics graphics, Graphics2D graphics2D, Composite composite) {
        ...
        if (this.teLabel == null) {
            this.teLabel = this.resMan.newTextElement(this.screenId, font, buttonModel.getLabel(), false);
        } else {
            this.teLabel.setString(buttonModel.getLabel());
        }
